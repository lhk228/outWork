...
const INCLUDE_PATH 	= "/elim/include/";
const POPUP_PATH    = "/elim/include/popup/";
const PAGE_PATH 		= "/elim/include/page/";
...
$(document).ready(function(){
	...
	//-- 닫기버튼 클릭 : 팝업닫기
	$(document).on("click",".btn_close",function(){ popupControl('hide');});
